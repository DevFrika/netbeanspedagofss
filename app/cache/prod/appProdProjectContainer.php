...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'pedagogie.filierehandle' => 'getPedagogie_FilierehandleService',
            'pedagogie.printhandle' => 'getPedagogie_PrinthandleService',
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'eu-cdbr-azure-north-e.cloudapp.net', 'port' => 3306, 'dbname' => 'pfefss', 'user' => 'b5bc3dc18bb01b', 'password' => '2dc16253', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Pedagogie\\PedagogieBundle\\Entity'))), 'Pedagogie\\PedagogieBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('PedagogiePedagogieBundle' => 'Pedagogie\\PedagogieBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_599d8968f4eaf3d22fb046117cbbdd2863fa9ffca3dfd84fdc85991e9ba2a796');
    ...
    /*
     * Gets the 'pedagogie.filierehandle' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Pedagogie\PedagogieBundle\Services\FiliereHandle A Pedagogie\PedagogieBundle\Services\FiliereHandle instance.
     */
    protected function getPedagogie_FilierehandleService()
    {
        return $this->services['pedagogie.filierehandle'] = new \Pedagogie\PedagogieBundle\Services\FiliereHandle();
    }

    /*
     * Gets the 'pedagogie.printhandle' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Pedagogie\PedagogieBundle\Services\PrintHandle A Pedagogie\PedagogieBundle\Services\PrintHandle instance.
     */
    protected function getPedagogie_PrinthandleService()
    {
        return $this->services['pedagogie.printhandle'] = new \Pedagogie\PedagogieBundle\Services\PrintHandle();
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('diopisemou@gmail.com');
        $a->setPassword('Nass0Nabou');
        $a->setAuthMode(NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\PedagoFss\\UserBundle/Resources/views'), 'PedagoFssUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Pedagogie\\PedagogieBundle/Resources/views'), 'PedagogiePedagogie');
        $instance->addPath(($this->targetDirs[3].'\\src\\Fss\\Website\\DepartementBundle/Resources/views'), 'FssWebsiteDepartement');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('573b72bebf1b69.88219521')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PedagoFssUserBundle' => 'PedagoFss\\UserBundle\\PedagoFssUserBundle',
                'PedagogiePedagogieBundle' => 'Pedagogie\\PedagogieBundle\\PedagogiePedagogieBundle',
                'FssWebsiteDepartementBundle' => 'Fss\\Website\\DepartementBundle\\FssWebsiteDepartementBundle',
                'EnseparHtml2pdfBundle' => 'Ensepar\\Html2pdfBundle\\EnseparHtml2pdfBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdProjectContainer',
            'database_host' => 'eu-cdbr-azure-north-e.cloudapp.net',
            'database_port' => 3306,
            'database_name' => 'pfefss',
            'database_user' => 'b5bc3dc18bb01b',
            'database_password' => '2dc16253',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'diopisemou@gmail.com',
            'mailer_password' => 'Nass0Nabou',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'diopisemou@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Nass0Nabou',
