 ...
 */
class Situations extends \Pedagogie\PedagogieBundle\Entity\Situations implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Pedagogie\\PedagogieBundle\\Entity\\Situations' . "\0" . 'id', '' . "\0" . 'Pedagogie\\PedagogieBundle\\Entity\\Situations' . "\0" . 'situations', '' . "\0" . 'Pedagogie\\PedagogieBundle\\Entity\\Situations' . "\0" . 'enseignants');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Situations $proxy) {
    ...
    public function setSituations($situations)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSituations', array($situations));

        return parent::setSituations($situations);
    }
    ...
    public function getSituations()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSituations', array());
