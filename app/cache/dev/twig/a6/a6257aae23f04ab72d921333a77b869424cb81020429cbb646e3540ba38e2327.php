...
/* PedagogiePedagogieBundle:admin/devoir:updatedevoirlayout.html.twig */
class __TwigTemplate_44e2a935fc8af2aba4e3030beb56bfca747b1e0138800017a26d122635275b77 extends Twig_Template
{
    ...
    {
        $__internal_26cd1459cf1deac42799e8a16c50b1cd6409ff07997ebe6bd3fd0f6c48267a19 = $this->env->getExtension("native_profiler");
        $__internal_26cd1459cf1deac42799e8a16c50b1cd6409ff07997ebe6bd3fd0f6c48267a19->enter($__internal_26cd1459cf1deac42799e8a16c50b1cd6409ff07997ebe6bd3fd0f6c48267a19_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "PedagogiePedagogieBundle:admin/devoir:updatedevoirlayout.html.twig"));
...
\t\t\t\t
                  ...
                  <div class=\"form-group dev-form-group\">
                    ...
                    <select id=\"depselect\" onchange=\"devLoadFiliere(this.value,'filselect')\" class=\"form-control\">
\t\t\t\t\t\t";
        // line 35
...
\t\t\t\t  <!-- Filieres -->
                  <div class=\"form-group dev-form-group\">
                    ...
                    <select id=\"filselect\" onchange=\"devLoadClasse(this.value,'clsselect')\" class=\"form-control\">
\t\t\t\t\t\t
\t\t\t\t\t</select>
\t\t\t\t\t<span class=\"help-block\"></span>
                  </div>
...
\t\t\t\t  <!-- Classes -->
                  <div class=\"form-group dev-form-group\">
                    <label> Classes </label>
                    <select id=\"clsselect\" onchange=\"devLoadGroupe(this.value,'grpselect')\" class=\"form-control\">
\t\t\t\t\t\t
\t\t\t\t\t</select>
\t\t\t\t\t<span class=\"help-block\"></span>
                  </div>
...
\t\t\t\t  <!-- Groupes -->
                  <div class=\"form-group dev-form-group\">
                    <label> Groupes </label>
                    <select id=\"grpselect\" onchange=\"devLoadDiscipline(this.value,'disselect')\" class=\"form-control\">
\t\t\t\t\t\t
\t\t\t\t\t</select>
\t\t\t\t\t<span class=\"help-block\"></span>
                  </div>
...
\t\t\t\t  <!-- Disciplines -->
                  <div class=\"form-group dev-form-group\">
                    ...
                    <select id=\"disselect\" onchange=\"devLoadMatiere(this.value,'matselect')\" class=\"form-control\">
\t\t\t\t\t\t
\t\t\t\t\t</select>
\t\t\t\t\t<span class=\"help-block\"></span>
                  </div>
...
\t\t\t\t  <!-- Matieres -->
                  <div class=\"form-group dev-form-group\">
                    ...
                    <select id=\"matselect\" onchange=\"devLoadEnseignant(this.value,'ensselect')\" class=\"form-control\">
\t\t\t\t\t\t
\t\t\t\t\t</select>
\t\t\t\t\t<span class=\"help-block\"></span>
                  </div>
...
";
        ...
        $__internal_26cd1459cf1deac42799e8a16c50b1cd6409ff07997ebe6bd3fd0f6c48267a19->leave($__internal_26cd1459cf1deac42799e8a16c50b1cd6409ff07997ebe6bd3fd0f6c48267a19_prof);

    }

    public function getTemplateName()
    {
        return "PedagogiePedagogieBundle:admin/devoir:updatedevoirlayout.html.twig";
    }
