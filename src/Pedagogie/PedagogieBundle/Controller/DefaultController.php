...
class DefaultController extends Controller
{
    ...
    public function indexAction()
    {
			...
			$this->allperiode = $filhandle->getAllPeriode($this);
			$this->allsemestre = $filhandle->getAllSemestre($this);
